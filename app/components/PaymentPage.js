        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xs sm:text-sm mt-1">
              ...
              {payments.reduce((acc, p) => acc + p.amount / 100, 0)} raised
            </p>
          </div>
                  ...
                  <ul>
                    {payments
                      ...
                      .map((donor, index) => (
                        <li
                          key={donor._id || index}
                          className="mb-3 p-2 bg-gray-600 rounded break-words"
                        >
            ...
            <div className="bg-gray-700 p-4 sm:p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={!paymentform.amount || !paymentform.name.trim()}
