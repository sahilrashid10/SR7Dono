    ...
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base">
        <div className="font-bold flex gap-6 md:gap-20 md:text-5xl justify-center items-center text-3xl">
          <span>
            SR7<span className="text-orange-600 text-2xl">DONO</span>
          </span>
        </div>
        ...
        <div className="flex gap-5 justify-around flex-col md:flex-row">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            ...
            <p className="text-center">
              Your biggest supporters are always ready to cheer you on and lend a hand in your journey. Whether it’s a word of encouragement or a helping hand, they’ve got your back every step of the way.
            </p>
          </div>
          <div className="item space-y-3 flex flex-col items-center justify-center">
            ...
            <p className="text-center">
              Your fans believe in your vision and are eager to invest in your growth. Every contribution big or small fuels your passion and brings you closer to your dreams.
            </p>
          </div>
          <div className="item space-y-3 flex flex-col items-center justify-center">
            ...
            <p className="text-center">
              True supporters don’t just watch from the sidelines—they join the game. Your fans are ready to brainstorm, create, and grow with you, turning shared dreams into shared successes.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <div className="w-[90%] h-[40vh] md:w-[50%] lg:w-[50%] xl:w-[50%]">
          <div className="flex justify-center items-center gap-6 h-full">
            ...
            <a href="mailto:sahilrashidganaie@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Gmail">
              <img src="/gmail.svg" alt="Gmail" className="invert w-20 h-20 hover:scale-110 transition-transform" />
            </a>
